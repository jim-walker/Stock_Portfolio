...
const renderBtns = function () {
  ...
  for (let i = 0; i < stocksList.length; i++) {
    const itemBtn = $('<button class="symbolBtn btn btn-dark w-100 m-2">');
    itemBtn.attr('stockSymbol', stocksList[i]);
    itemBtn.text(stocksList[i]);
    $('#listButtons').append(itemBtn);
  }
}
renderBtns();
